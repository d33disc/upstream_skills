...
1. Develop your artifact by editing the generated code
1. Bundle all code into a single HTML file using `scripts/bundle-artifact.sh`
1. Display artifact to user
1. (Optional) Test the artifact
